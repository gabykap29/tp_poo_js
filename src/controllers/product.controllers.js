...
crtlProducts.getProducts = async (req, res) => {
  try {
...
crtlProducts.createProduct = async (req, res) => {
  try {
    const body = req.body;
...
crtlProducts.getProduct = async (req, res) => {
  try {
...
crtlProducts.updateProduct = async (req, res) => {
  try {
    const { id } = req.params;
    const body = req.body;
...
crtlProducts.deleteProduct = async (req, res) => {
  try {
    const { id } = req.params;
